...
router.post('/', validate({ body: createQuotationSchema }), asyncHandler(async (req: any, res: any) => {
...
router.put('/:id', validate({ params: objectIdParam, body: updateQuotationSchema }), asyncHandler(async (req: any, res: any) => {
...
router.post('/:id/send', validate({ params: objectIdParam }), asyncHandler(async (req: any, res: any) => {
...
router.post('/:id/convert-to-order', validate({ params: objectIdParam }), asyncHandler(async (req: any, res: any) => {
