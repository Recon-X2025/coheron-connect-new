...
router.post("/init", requireAIAddon("chatbot"), asyncHandler(async (req: any, res) => {
...
router.post("/message", requireAIAddon("chatbot"), asyncHandler(async (req: any, res) => {
...
router.get("/sessions", requireAIAddon("chatbot"), asyncHandler(async (req: any, res) => {
...
router.get("/sessions/:id", requireAIAddon("chatbot"), asyncHandler(async (req: any, res) => {
