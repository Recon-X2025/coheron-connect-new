...
router.get('/zones', asyncHandler(async (req: any, res: any) => {
...
router.post('/zones', asyncHandler(async (req: any, res: any) => {
  const zone = await WarehouseZone.create(req.body);
  res.status(201).json(zone);
}));

// PUT /zones/:id - update zone
router.put('/zones/:id', asyncHandler(async (req: any, res: any) => {
...
router.get('/bins', asyncHandler(async (req: any, res: any) => {
...
router.post('/bins', asyncHandler(async (req: any, res: any) => {
  const data = { ...req.body };
  if (!data.barcode) {
...
router.put('/bins/:id', asyncHandler(async (req: any, res: any) => {
...
router.post('/bins/:id/assign', asyncHandler(async (req: any, res: any) => {
...
router.post('/bins/:id/transfer', asyncHandler(async (req: any, res: any) => {
