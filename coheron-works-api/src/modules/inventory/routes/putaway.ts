...
// DELETE /rules/:id
router.delete('/rules/:id', asyncHandler(async (req: any, res) => {
...
// POST /suggest
router.post('/suggest', asyncHandler(async (req: any, res) => {
