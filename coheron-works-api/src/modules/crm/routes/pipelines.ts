...
router.post('/:id/stages', authenticate, asyncHandler(async (req, res) => {
...
// Update stage
router.put('/:id/stages/:stageId', authenticate, asyncHandler(async (req, res) => {
  const update: any = {};
...
// Delete stage
router.delete('/:id/stages/:stageId', authenticate, asyncHandler(async (req, res) => {
  const pipeline = await Pipeline.findByIdAndUpdate(
    req.params.id,
